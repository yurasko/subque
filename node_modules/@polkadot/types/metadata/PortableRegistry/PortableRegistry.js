...
export class PortableRegistry extends Struct {
  constructor(registry, value) {
    ...
    const [names, _params] = extractNames(this, this.types);
    _classPrivateFieldLooseBase(this, _names)[_names] = names;
    _classPrivateFieldLooseBase(this, _types)[_types] = extractTypeMap(this.types); // Try and extract the AccountId/Address/Signature type from UncheckedExtrinsic

    if (_params.SpRuntimeGenericUncheckedExtrinsic) {
      // Address, Call, Signature, Extra
      const [addrParam,, sigParam] = _params.SpRuntimeGenericUncheckedExtrinsic;
